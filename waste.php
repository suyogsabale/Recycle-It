  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Do you want to send request to collecter...?</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary">
            <a href='' id="link_address" style="text-decoration: none;color: white;" >
                Yes
            </a>
        </button>
      </div>
       ...
       <ul class="nav navbar-right top-nav">           
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" style='background: linear-gradient(60deg, rgb(143 218 245) 0%, rgb(149 233 250) 100%);float: right;'>
            <ul class="nav navbar-nav side-nav" style="background: linear-gradient(60deg, rgba(84,58,183,1) 0%, rgba(84,58,183,1) 100%); ">
                ...
                <li>
                    <a href="http://localhost/pbl/phpGmailSMTP/trash.php"><i class="fa fa-fw fa fa-plus-square" style="color: white;" ></i><span style="background: none;color: white;" >New aplication</span></a>
                </li>
                <li>
   ...
   if($total!=0) {
     ...
     echo "
           <tr class='panel panel'>
               ...
               <td><button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal' onclick='getData(".$result['Id'].")' >
 Request
</button></td>
...
function getData(data){
    let link = document.getElementById("link_address");
